...
def compute_ecl(pd_12m, severity_tier, bundle):
    ...
    return {
        "ifrs9_stage": stage,
        "ecl_ifrs9_usd": ecl_ifrs9,
        "ecl_cecl_usd": ecl_cecl,
        "pd_lifetime": pd_lifetime,
        "pd_12m_macro_adj": pd_12m_macro,
...
def explain_ecl(pd_12m, severity_tier, bundle):
    ...
    if is_severe and pd_12m > bundle["stage3_pd_threshold"]:
        ...
        trigger = (
            "pd_12m exceeds the SICR threshold" if pd_12m > sicr_threshold else "severity_tier is an elevated tier"
        )
        reasons.append(
            {
