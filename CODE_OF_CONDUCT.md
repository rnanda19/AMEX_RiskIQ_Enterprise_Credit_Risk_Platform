...
This is currently a solo-maintained portfolio project. The maintainer
(contact below) is responsible for clarifying and enforcing standards of
acceptable behavior in this repository's issues, pull requests, and any
other project spaces, and will take appropriate and fair corrective action
...
3. **Temporary Ban** -- A temporary ban from any sort of interaction or
   public communication with the project for a specified period of time.
